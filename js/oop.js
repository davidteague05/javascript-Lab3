...
let  Hamburger = {
    ...
    cheese: ["no cheese", "cheddar","mozzarella"],
    meats:["beef","chicken","vegetarian", "fish"],
    sauce : ["bbq","teriyaki","ketchup"],
    showHamburger : function(){
        return `I have a burger with ${this.meats[0]}, ${this.cheese[0]}, ${this.toppings[0]}s, ${this.toppings[1]} and ${this.sauce[2]} on a ${this.buns[1]} bun.`;
    }
};

output2.textContent = Hamburger.showHamburger();
